        ...
        <div className="modal-overlay active">
            <div className="modal-content create-group-modal">
                        ...
                        <div className="enhanced-form-group">
                            ...
                            <div className="role-descriptions">
                                ...
                                <p className="role-desc">
                                    <strong>Viewer:</strong> Can view and comment on the document<br />
                                    <strong>Editor:</strong> Can view, comment, and edit the document<br />
                                    <strong>Admin:</strong> Full access including sharing and managing permissions
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="modal-footer">
                    <button onClick={onClose} className="btn-enhanced btn-secondary-enhanced">
                        Cancel
                    </button>
                    <button
